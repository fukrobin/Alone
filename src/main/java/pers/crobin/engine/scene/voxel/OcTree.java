...
public class OcTree {
    ...
    public OcTree setSpaceInfo(int posX, int posY, int posZ, int size) {
        this.spaceInfo = (short)(posX << POSITION_X_SHIFT | posY << POSITION_Y_SHIFT | posZ << POSITION_Z_SHIFT | (size - 1) << SIZE_SHIFT);
        return this;
    }
    ...
    public static class Leaf extends OcTree {
        ...
        @Override public OcTree.Leaf setSpaceInfo(int posX, int posY, int posZ, int size) {
