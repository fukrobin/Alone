...
public class EngineThread {
    ...
    private static final ThreadLocal<EngineManager> LINKER        = new ThreadLocal<>();
    ...
    public static EngineManager getLinker() {
        return LINKER.get();
    }

    public static void setLinker(EngineManager engineManager) {
        LINKER.set(engineManager);
    }
