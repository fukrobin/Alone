...
public class EventManager {
     ...
     */
    public <T extends IEvent> void register(@Nullable EventHandler<? extends IEvent> handler, Class<T> clazz) {
        boolean flag = false;
    ...
    public <T extends IEvent> void unregister(@Nonnull EventHandler<? extends IEvent> handler, Class<T> clazz) {
