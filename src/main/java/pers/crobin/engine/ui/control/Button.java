...
public class Button extends Region {
    ...
    public void draw(long context, float offsetX, float offsetY) {
        ...
        textControl.draw(context, offsetX, offsetY);
    }
    ...
    public String toJsonString() {
        return new GsonBuilder().registerTypeAdapter(Button.class, (JsonSerializer<Button>) (src, typeOfSrc, context) -> src.getJsonObject()).create().toJson(this);
    }
